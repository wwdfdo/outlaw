    ...
    <>
      <div className="w-[95%] mx-auto pt-[5rem]">
        ...
        <div className="grid grid-cols-5  py-20">
          <div className=" bg-[#c9a275ba] w-[302px] h-[480px] survivors relative item cursor-pointer">
            <svg class="clips">
            ...
            <div className=" absolute -bottom-2 right-0 animation survivor-girl">
          ...
          <div className="relative w-[293px]">
            <div className=" bg-[#e6d4b5] item-parishoot w-[314px] h-[283px] item relative">
              <svg class="clips">
              ...
              <div className=" flex items-center text-2xl font-bold tracking-widest absolute bottom-10 left-4 animation atsui-question uppercase ">
                <span className="animation flex items-center font-[900] animation survivor-arrow opacity-0  ">
                  &#62;
                </span>
                John
              </div>
              <div className="absolute top-8 right-6 parishoots animation">
            ...
            <div className="bottle bg-[#847361] w-[353px] h-[215px] absolute -left-[1.2rem] -bottom-[3px] item">
              <svg class="clips">
              ...
              <div className=" flex items-center text-xl font-bold absolute  bottom-8 left-8 atsui-house animation uppercase">
                <span className="animation flex items-center font-[900] animation survivor-arrow opacity-0 ">
                  &#62;
                </span>
                Shootout
              </div>
              <div className=" absolute bottom-0 w-[8rem] right-4 bottle animation">
          ...
          <div className="bg-[#d3a97a] w-[277px] h-[480px] relative fourth-card ml-8 item">
            <svg class="clips">
            ...
            <div className=" flex items-center text-xl font-bold absolute  top-[6rem] left-8 atsui-house animation">
              <span className="animation flex items-center font-[900] animation survivor-arrow opacity-0 ">
                &#62;
              </span>
              LOST SURVIVOR
            </div>
            <div className=" absolute  right-0 bottom-0 lost-survivor animation">
          ...
          <div className=" bg-[#ceaf8c] w-[278px]  h-[480px] relative fifth-card ml-6 item">
            <svg class="clips">
            ...
            <div className=" flex items-center text-xl font-bold absolute  bottom-6 left-8 atsui-house animation">
              <span className="animation flex items-center font-[900] animation survivor-arrow opacity-0 ">
                &#62;
              </span>
              SUMMIT
            </div>
            <div className="absolute  left-[12%] top-8 speaker animation">
          ...
          <div className="bg-[#e3b275] w-[283px] h-[480px] relative sixth-card -ml-4 item">
            <svg class="clips">
            ...
            <span className=" absolute top-5 left-[50%] animation ">
              <IoIosLock size={48} />
            </span>
            <div className="text-xl  font-bold absolute  top-16 left-[45%] school-girl animation text-center opacity-0 revealed uppercase">
              Horse
              <br />
              Riding
            </div>
            <div className="absolute -bottom-5 left-10 back-girl animation">
      ...
      <div className="w-[95%] mx-auto flex justify-center">
        <p className="w-2/3 tracking-wider leading-loose text-[#3948be]">
