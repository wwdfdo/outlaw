...
const Roadmap = () => {
  return (
    <div className="lg:pt-40 pt-20 lg:pb-20 pb-5 lg:bg-roadmap-bg bg-roadmap-bg   bg-top bg-cover bg-no-repeat bg-blend-darken bg-[#eb3c27] bg-opacity-85  bg-fixed relative">
